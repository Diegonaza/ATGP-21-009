...
public class GamePanel extends JPanel implements Runnable{
   ...
   // public final int  screenHigth = tileSize * maxScreenRow;
    ...
    public AssetDeployer ad = new AssetDeployer(this);
   ...
   @Override
    ...
    public void update(){
        ...
        player.update();//calls Player variables changes
        
        npc[0].update();//Calls Citizen's variable changes.
